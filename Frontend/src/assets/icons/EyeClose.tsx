/**
 * @description Componente de ícone de Olho fechado.
 *
 * Esse componente renderiza um ícone de olho fechado em SVG. Este ícone pode ser usado para indicar a funcionalidade de mostrar ou ocultar informações, como senhas ou detalhes sensíveis.
 *
 * @component
 ...
 * */
export default function EyeCloseIcon({ className }: { className?: string }) {
  return (
    <svg
