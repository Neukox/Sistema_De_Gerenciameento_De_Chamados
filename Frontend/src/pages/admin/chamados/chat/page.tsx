...
/**
 * @description Página de Chamados por Chat do Administrador.
 *
...
export default function AdminChatTicketsPage() {
  ...
  >({
    queryKey: ["all-chat-tickets", { search: search, status: status }],
    queryFn: () => fetchTickets("chat", search, status),
  });
  ...
  return (
    <div className="w-full bg-base-200 dark:bg-base-100 flex justify-center min-h-[calc(100vh-5.0625rem)]">
      <div className="w-full max-w-screen-xl mb-8 px-4">
        <h1 className="my-6">Chamados por Chat</h1>
